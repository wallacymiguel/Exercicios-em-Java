...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Em qual número o gênio está pensando?");
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 330, 40, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 370, 120, 50));

        lblFrase.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase");
        lblFrase.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 130, 90));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/balao.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 10, 220, 250));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String r1 = "<html>Acertou, mizerávi!</html>";
        String r2 = "<html>Errou! Eu pensei no número " + valor + "</html>";
        
        String res = (num == valor)? r1:r2;
